...
def get_data():
    ...
    data = pd.read_csv(
        "fluorescent_polarization/data/graft_binding.csv",
        skiprows=1,
        header=None,
        usecols=[0, 1, 2, 3, 4, 14, 15, 16, 21, 22, 23],
        names=[
            "well",
            "enzyme",
            "ph",
    ...
    data[["enzyme", "ph"]] = data[["enzyme", "ph"]].astype("category")
    return data
...
def figure_one(location: str = "side", exclude_title: bool = False):
    """Demonstrate the impact of pH and enzyme on the fluorescence of each inhibitor"""
    ...
    plt.savefig("fluorescent_polarization/charts/figure_one.svg")
